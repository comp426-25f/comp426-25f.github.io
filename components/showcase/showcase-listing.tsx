...
export default function ShowcaseListing({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between w-full first:border-t border-b border-muted py-3">
      <div className="flex flex-row items-center gap-4">
        <img
          src={`/images/showcase/${teamNumber}.png`}
          className="rounded-lg h-[60px] w-[60px] object-contain"
          alt={title}
          width={60}
          height={60}
        />
