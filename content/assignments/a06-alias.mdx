...
1. Accept the **GitHub Classroom** assignment [here](https://classroom.github.com/a/QSHdYQjE). *This is a group assignment, so make sure that you accept the assigment in your team!* If you team has not yet been created, please do so.
