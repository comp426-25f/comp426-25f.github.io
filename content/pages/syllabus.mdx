...
- **LinkedIn**: [@ajaygandecha](https://www.linkedin.com/in/ajaygandecha/)
- **GitHub**: [@ajaygandecha](https://github.com/ajaygandecha)

**Section:** In-Person, TTh 3:30p-4:45p in Hanes Art Center 0121.


## Course Description

COMP 426 introduces students to the fundamentals modern, full-stack web development with an emphasis on today's best practices, modern tooling, and leading industry-prevalent frameworks.
...
_In cases of fractional points, grades will be rounded up if greater than 0.4999999999…_
...
- **Midterm 01**: Thursday, 9/11
- **Midterm 02**: Thursday, 10/30
